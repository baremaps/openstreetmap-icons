...
[1, 2, 4].forEach(function (pxRatio) {
  ...
  var suffix = pxRatio > 1 ? `@${pxRatio}x` : "";
  var pngPath = path.resolve(path.join(__dirname, `../dist/sprite${suffix}.png`));
  var jsonPath = path.resolve(path.join(__dirname, `../dist/sprite${suffix}.json`));
